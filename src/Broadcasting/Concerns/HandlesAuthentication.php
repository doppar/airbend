...
trait HandlesAuthentication
{
     ...
     * @return bool
     */
    protected function authenticatePrivateChannel(TcpConnection $conn, string $channel,  array $authData): bool
    {
     ...
     */
    protected function authenticatePresenceChannel(TcpConnection $conn, string $channel,  array $authData): array|false
    {
        $socketId = $this->clientMetadata[$conn->id]['socket_id'] ?? null;
        $auth = $authData['auth'] ?? null;
     ...
     * @return void
     */
    protected function subscribeToPrivateChannel(TcpConnection $conn, string $channel,  array $authData): void
    {
